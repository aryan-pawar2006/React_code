...
export default function Navbar(props) {
  ...
  <div className="container-fluid">
    ...
    <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="/aboutnavbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
...
Navbar.propTypes = {
  ...
  about: PropTypes.string, // should match defaultProps type
};
